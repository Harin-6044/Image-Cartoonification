...
def landscape():
    ...
    def cartoonify_landscape(image_path):
        ...
        save_image_landscape = Button(top_1,text = "Save Cartoon Image",command = lambda: save(resized_6,image_path),padx = 30,pady = 5)
...
def portrait():
    ...
    def cartoonify_portrait(image_path):
        ...
        save_image_portrait = Button(top_2,text = "Save Cartoon Image",command = lambda: save(resized_6,image_path),padx = 30,pady = 5)
